...
def process_rosbag_to_SampleResult(rosbag_path, datatypes, frequency, offset_points, target_points, T, episode_start_time_in_sec=None, episode_end_time_in_sec=None):
    ...
    time_stamps, mat = ofrt.get_timeseries_mat(rosbag_path, episode_start_time_in_sec, episode_end_time_in_sec)
