...
from baxter_as_gps_ros_agent.ros_topic_filters.right_arm_joint_angle_filter import RightArmJointAngleFilterPosition, RightArmJointAngleFilterVelocity
...
map_datatype_to_filter = {
    JOINT_ANGLES: {
        ...
        "msg_type": JointState,
        "filter_class": RightArmJointAngleFilterPosition,
    },
    JOINT_VELOCITIES: {
        "topic_name": "/robot/joint_states",
        "msg_type": JointState,
        "filter_class": RightArmJointAngleFilterVelocity,
    },
}
